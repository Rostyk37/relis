...
logoo = Logo ('logo.png', 335, -900, 0)

sprite1 = GameSprite('rocket.png', 0, 325, 0)
sprite2 = Sprite2('rocket90.png', 500, 300, 0)

text = Text('nametext.png', 650, 100,0)

skip = Skip('skip.png', 900, 600,0)

controler = Controlerr('control.png', 0, 0,0)

komix = Komix('komix.png', 0, 0,0)
button_start = Button('button.png', win_width / 24,win_height / 7,)
button_settings = Button('button.png', win_width / 24,win_height / 2.8,)
button_ShowScores = Button('button.png', win_width / 24,win_height / 1.75,)
button_quit = Button('button.png', win_width / 24,win_height/ 1.27,)

buttonshow_fps = Button('button.png', 50, 100,)

button_back_settings = Button('button.png', 550, 550,)
...
def quit_game():
    clickbutton.play()
    global menugame,menusettings,logo,komix_start,Controler,startgame,gamemode,gamemodefon,gamestart,gamemenufon,opensettings,openmenu
    print("Quit Game")
    logo = True
    menugame = False
    menusettings = False
...
spritee = pygame.transform.scale(spritee, (win_width,win_height))
timeblack = 0
alph = 0
...
while final:
    ...
    #window.blit(komixfinal, (komixfinalrect.x, komixfinalrect.y))
